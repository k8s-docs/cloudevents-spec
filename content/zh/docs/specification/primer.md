---
title: "CloudEvents 入门 - 版本 1.0"
linkTitle: "入门"
weight: 1
description: >
  此非规范的文档提供了CloudEvents说明书的概述。
type: "docs"
---

## Abstract

此非规范的文档提供了 CloudEvents 说明书的概述。
它是为了补充 CloudEvent 规范，以提供额外的背景和洞察规范的发展过程中作出的历史和设计决策。
这使得规范本身着眼于规范的技术细节。
...
所述 CloudEvents 说明书定义了四种不同种类的形成分层结构模型的协议元素的。
...
与前一节中，世界的当前状态的检查（和理解）是该集团非常重要的。
为此，这在实践中目前使用的现有当前事件格式抽样聚集。
...
[文档](https://docs.microsoft.com/en-us/azure/event-grid/event-schema)

#### 谷歌 - Cloud Functions (potential future)
...
[文档](https://github.com/openstack/pycadf/blob/master/doc/source/event_concept.rst)
...
[文档](https://www.adobe.io/apis/cloudplatform/events/documentation.html)
